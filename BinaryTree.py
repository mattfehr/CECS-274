...
'''
bt = BinaryTree()
bt.r = BinaryTree.Node(1, 'A') # bt.r is the root
b = bt.r.insert_right(BinaryTree.Node(2, 'B'))
c = bt.r.insert_left(BinaryTree.Node(3, 'C'))
d = b.insert_right(BinaryTree.Node(4, 'D'))
e = c.insert_left(BinaryTree.Node(5, 'E'))
print(bt)
'''
